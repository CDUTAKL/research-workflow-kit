...
- Stage 10 writing is split into two gates: **10A writing blueprint and first draft** locks the chapter structure, section titles, figure/table placement, claim-evidence responsibilities, and citation gaps before long-form prose; **10B polish and manuscript integration** handles final section logic, hedging, figure captions, Word/WPS cross-references, DOCX production, Zotero/BibTeX insertion, and rendered PDF checks after the draft exists. Do not start final figure numbering before the正文初稿 is stable.
