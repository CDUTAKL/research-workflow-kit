...
| Documents / DOC | 10, 11 | Word thesis drafting and editing | `writing-outline.md`, `final-audit.md` | Use for `.docx` production |
...
| Canva | 12 optional | visual polish for defense or poster materials | `defense-prep.md` | Optional, not a source of evidence |
...
| 6. Experiment run and monitoring | `$research-experiment-engineering` | GitHub commit trace, AutoDL/SSH, Notion progress |
...
| 9. Figure and table planning | `$research-paper-figures`, Image Gen visual reference, nature-figure source, Figma/PPTX/SVG/TikZ/Python formal redraw | Image Gen for attractive reference; Spreadsheets for table exports; Figma/PPTX for model diagram redraw/refinement; Presentations for PPTX refinement |
| 10. Paper writing | `$research-paper-writing`, nature-polishing source, Documents | Zotero for citations |
| 11. Word / LaTeX / PDF production | Documents, LaTeX Tectonic, PDF | Zotero/BibTeX |
| 12. Final audit and defense preparation | `$research-final-audit`, Presentations, nature-paper2ppt source | Notion tasks, Canva optional |
...
| Figma | `.network.json` specs, claim/evidence records, and figure QA |
