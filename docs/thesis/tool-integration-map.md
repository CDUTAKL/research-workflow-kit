...
| 10. Paper writing | `$research-paper-writing`, nature-polishing source, Documents | Zotero for citations and BibTeX export; check `section-citation-map.md`, `citation-provenance.md`, and `zotero-literature-hub.md` before polishing |
