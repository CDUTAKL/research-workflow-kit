...
|---|---|---|---|---|---|---|---|
| EXT-NATURE | `https://github.com/Yuan1z0825/nature-skills` | `external-skill-candidates/nature-skills` | `62fcfa8` | MIT | academic search routing, data availability, citation batches, source-grounded readers, paper-to-PPT QA, figure/prose polish, reviewer-style precheck | `academic-search-policy.md`, `research-data-availability`, `$research-literature-review`, `$research-final-audit`, `$research-paper-figures`, `$research-paper-writing` | refreshed; `nature-response` excluded |
