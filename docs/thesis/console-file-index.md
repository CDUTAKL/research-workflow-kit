...
Use this file as the low-noise map of the research console. The Dashboard is the daily entry point; this index explains which source files matter now and which files are only for audit or compatibility.

## File Layers

| Layer | When to Open | Files | Rule |
|---|---|---|---|
...
1. Dashboard current workspace.
2. One evidence core file linked by the Dashboard.
3. One stage workspace file if needed.

If more than three source files are open, write the reason in `workflow-edit-log.md` or reduce the task.

## Weekly Rule

During weekly review, check:

- which evidence core file changed;
