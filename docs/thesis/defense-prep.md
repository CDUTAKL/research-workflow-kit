...
- Use draw.io or Visio exports for structured diagrams; use Figma or BioRender only when a slide needs visual refinement beyond draw.io/Visio/PPTX layout.
