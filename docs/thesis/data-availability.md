...
- Use this file to record whether data behind thesis claims, figures, and experiments can be found, reproduced, shared, or explained.
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| DATA-001 | TBD | CLM-001/TBD | EXP-001/TBD | TBD | TBD | TBD | private/public/restricted/TBD | TBD | TBD | TBD | missing |  |

## Result Data Traceability
...
| Dataset ID | Can Share? | Restriction Reason | Safe Public Description | Replacement / Synthetic Example | Approval Needed | Status |
|---|---|---|---|---|---|---|
| DATA-001 | TBD | privacy/license/advisor/project/TBD | TBD | TBD | TBD | pending |

## Final Availability Statement Draft
