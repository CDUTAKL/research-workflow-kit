...
This skill is a lightweight Codex-native synthesis. It does not copy private or unclear-license content.

## Primary MIT Sources

- `external-skill-candidates/wanshuiyin-auto-research-skills/skills/paper-plan`
...
- `external-skill-candidates/imbad-academic-research-skills`
  - CC BY-NC 4.0. Use only as high-level inspiration for personal academic workflows.
- `external-skill-candidates/kgraph-paper-writer-skill`
  - License status unclear/private in README. Do not copy content into this skill.
