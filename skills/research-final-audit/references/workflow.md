...
|---|---|---|---|---|---|---|
| Figure | `figures/references/...` | pass/revise/failed | `.network.json`/model.py/data/source note | draw.io/Windows Visio/Python/PPTX/SVG/TikZ/Figma/BioRender | pass/pending/revise | accept/revise/block |
...
- Structured model, method, workflow, and architecture diagrams used Mac draw.io or Windows Visio route unless a reason for another tool is recorded.
...
| Network architecture diagram | draw.io/Visio redraw record, `.network.json` spec, layout/connections/panels/audit fields, SVG/PDF/PNG/VSDX outputs, PPTX mode, QA report, topology-only caption | `$research-paper-figures` |
...
| Zotero screening loop | A/B/C/D labels, Zotero queue, feedback-learning status, section handoff, exclusion reasons | `$research-literature-review`, Zotero, Spreadsheets |
