...
5. Audit reproducibility records, including run commands, configs, seeds, splits, code version, metric files, output directories, code contract checks, and autoresearch verify/guard records when the thesis console exists.
